...
public class MidasBlocks {
    ...
    public static final Block DRIED_GOLDEN_KELP_BLOCK = new Block(AbstractBlock.Settings.create().mapColor(MapColor.PALE_YELLOW).strength(0.5F, 2.5F).sounds(BlockSoundGroup.GRASS));
    ...
    private static void midasRegisterBlock(String itemId, Block block) {
        Registry.register(Registries.BLOCK, Identifier.of(MidasHunger.MOD_ID, itemId), block);
    }
